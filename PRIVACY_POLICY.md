...
The extension does not share, sell, or transmit any data to any external services, companies, or servers.

USER CONTROL & UNINSTALLATION

Uninstalling the extension stops all data collection immediately.
Any previously stored data remains on your device until you choose to delete it manually.
The extension never removes data without your consent.
